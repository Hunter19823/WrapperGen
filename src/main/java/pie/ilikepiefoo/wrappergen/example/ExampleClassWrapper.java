...
public class ExampleClassWrapper<T extends NavigableMap<String, List<Set<T>>>, G extends T, F extends H, H extends List<F>> extends ExampleClass<T, G, F, H> {
    ...
    public ExampleClassWrapper(String arg0, int arg1) {
        super(arg0, arg1);
    }

    public ExampleClassWrapper(String arg0, int arg1, T arg2) {
    ...
    @Override
    public void varArgsExample(String... arg0) {
    ...
    @Override
    public <COMPLEX_GENERIC extends Number> void complexGenericExample(COMPLEX_GENERIC arg0) {
    ...
    @Override
    public <COMPLEX_GENERIC extends Number> void setMixedGenerics(COMPLEX_GENERIC arg0, T arg1) {
